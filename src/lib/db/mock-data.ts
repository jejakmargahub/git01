...
export const DEMO_RELATIONSHIPS: Relationship[] = [
  // Buyut → Kakek (parent)
  { id: "r-001", familyId: "fam-001", fromMemberId: "m-001", toMemberId: "m-003", relationType: "parent", createdAt: new Date() },
  { id: "r-002", familyId: "fam-001", fromMemberId: "m-001", toMemberId: "m-005", relationType: "parent", createdAt: new Date() },
  { id: "r-003", familyId: "fam-001", fromMemberId: "m-002", toMemberId: "m-003", relationType: "parent", createdAt: new Date() },
  { id: "r-004", familyId: "fam-001", fromMemberId: "m-002", toMemberId: "m-005", relationType: "parent", createdAt: new Date() },
  // Buyut pasangan
  { id: "r-005", familyId: "fam-001", fromMemberId: "m-001", toMemberId: "m-002", relationType: "spouse", createdAt: new Date() },
  // Kakek → Orang Tua (parent)
  { id: "r-006", familyId: "fam-001", fromMemberId: "m-003", toMemberId: "m-006", relationType: "parent", createdAt: new Date() },
  { id: "r-007", familyId: "fam-001", fromMemberId: "m-004", toMemberId: "m-006", relationType: "parent", createdAt: new Date() },
  // Kakek pasangan
  { id: "r-008", familyId: "fam-001", fromMemberId: "m-003", toMemberId: "m-004", relationType: "spouse", createdAt: new Date() },
  // Om Hwa → Ko Jun (parent)
  { id: "r-009", familyId: "fam-001", fromMemberId: "m-005", toMemberId: "m-008", relationType: "parent", createdAt: new Date() },
  // Orang Tua → Anak (parent)
  { id: "r-010", familyId: "fam-001", fromMemberId: "m-006", toMemberId: "m-009", relationType: "parent", createdAt: new Date() },
  { id: "r-011", familyId: "fam-001", fromMemberId: "m-006", toMemberId: "m-010", relationType: "parent", createdAt: new Date() },
  { id: "r-012", familyId: "fam-001", fromMemberId: "m-007", toMemberId: "m-009", relationType: "parent", createdAt: new Date() },
  { id: "r-013", familyId: "fam-001", fromMemberId: "m-007", toMemberId: "m-010", relationType: "parent", createdAt: new Date() },
  // Orang Tua pasangan
  { id: "r-014", familyId: "fam-001", fromMemberId: "m-006", toMemberId: "m-007", relationType: "spouse", createdAt: new Date() },
  // Om Hwa → Kevin (parent)
  { id: "r-015", familyId: "fam-001", fromMemberId: "m-005", toMemberId: "m-011", relationType: "parent", createdAt: new Date() },
  // Papa & Mama → Daniel (parent)
  { id: "r-016", familyId: "fam-001", fromMemberId: "m-006", toMemberId: "m-012", relationType: "parent", createdAt: new Date() },
  { id: "r-017", familyId: "fam-001", fromMemberId: "m-007", toMemberId: "m-012", relationType: "parent", createdAt: new Date() },
  // Papa & Mama → Melody (parent)
  { id: "r-018", familyId: "fam-001", fromMemberId: "m-006", toMemberId: "m-013", relationType: "parent", createdAt: new Date() },
  { id: "r-019", familyId: "fam-001", fromMemberId: "m-007", toMemberId: "m-013", relationType: "parent", createdAt: new Date() },
  // Om Hwa pasangan
  { id: "r-020", familyId: "fam-001", fromMemberId: "m-005", toMemberId: "m-014", relationType: "spouse", createdAt: new Date() },
  // Om Hwa & Ci Linda → Melisa (parent)
  { id: "r-021", familyId: "fam-001", fromMemberId: "m-005", toMemberId: "m-015", relationType: "parent", createdAt: new Date() },
  { id: "r-022", familyId: "fam-001", fromMemberId: "m-014", toMemberId: "m-015", relationType: "parent", createdAt: new Date() },
  // Om Hwa & Ci Linda → Adrian (parent)
  { id: "r-023", familyId: "fam-001", fromMemberId: "m-005", toMemberId: "m-016", relationType: "parent", createdAt: new Date() },
  { id: "r-024", familyId: "fam-001", fromMemberId: "m-014", toMemberId: "m-016", relationType: "parent", createdAt: new Date() },
  // Ci Linda juga parent Ko Jun & Kev
  { id: "r-025", familyId: "fam-001", fromMemberId: "m-014", toMemberId: "m-008", relationType: "parent", createdAt: new Date() },
  { id: "r-026", familyId: "fam-001", fromMemberId: "m-014", toMemberId: "m-011", relationType: "parent", createdAt: new Date() },
  // Menantu (Pasangan Chris & Ko Jun)
  { id: "r-027", familyId: "fam-001", fromMemberId: "m-009", toMemberId: "m-017", relationType: "spouse", createdAt: new Date() },
  { id: "r-028", familyId: "fam-001", fromMemberId: "m-008", toMemberId: "m-018", relationType: "spouse", createdAt: new Date() },
  // Cicit (Anak Ko Jun & Stella)
  { id: "r-029", familyId: "fam-001", fromMemberId: "m-008", toMemberId: "m-019", relationType: "parent", createdAt: new Date() },
  { id: "r-030", familyId: "fam-001", fromMemberId: "m-018", toMemberId: "m-019", relationType: "parent", createdAt: new Date() },
];
...
export function getDemoMemberRelationships(familyId: string, memberId: string) {
  ...
  return rels.map((r) => {
    ...
    return { id: r.id, relationType, relatedMember };
  });
}
